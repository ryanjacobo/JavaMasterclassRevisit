package dev.lpa.NestedClassesAndTypes.Challenge;
...
public class Main {
    ...
    // method
    public static void printOrderedList(List<Employee> empList, String sortField){
        int currentYear = LocalDate.now().getYear();

        // local class
        // construct the employee String sentence
        class MyEmployee {
        ...
        // anonymous class
        // sort the employee list according given argument
        ...
        // print out the sorted list of employee sentence
